...
The visualization domain provides analytics and reporting capabilities through
Oracle Analytics Server and Oracle Analytics Cloud. These platforms allow
tenant users to create dashboards, workbooks, datasets, semantic models, and
operational reports. DIS integrates them into a managed lifecycle that covers
tenant onboarding, configuration, artifact deployment, backup, migration,
recovery, upgrade, and deletion.

The internship focuses principally on this domain. The activities include
analyzing OAS and OAC onboarding and migration workflows, validating analytics
artifacts, investigating integration issues, and contributing to OAC
cross-region Disaster Recovery automation. This scope requires collaboration
with the owners of configuration, orchestration, execution, and cloud-platform
services.
...
The work is performed in an existing cloud-native platform composed of several
microservices. Consequently, each feature requires understanding service
responsibilities, API contracts, workflow state, cloud resources, deployment
configuration, and operational constraints. The expected result is not an
isolated prototype, but a capability that integrates with the platform's
established engineering and delivery processes.
...
3 & OAC feature development & Design and implementation of cross-region Disaster Recovery capabilities, including recovery status, retry, rollback, restoration, and cleanup behaviour. \\
