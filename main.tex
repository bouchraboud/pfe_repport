...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=cyan,
    pdfauthor={Bouchra Boudiouane},
    pdftitle={Design and Development of Resilience and Automation Features for Oracle Analytics Cloud within Data Intelligence Services},
...
\blankpage  %page vide obligatoire
